...
let result = d3.group(data, d => d.sex_name);

// console.log(result)

rScale.domain(d3.extent(data, d => d.grade_id));
...
let simulation = d3.forceSimulation(nodes)
  ...
  .force("collision", d3.forceCollide().radius(d => (rScale(d.grade_id))));
